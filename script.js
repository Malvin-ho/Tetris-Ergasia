...
function draw() {
    ...
    const colorDark = '#1A1A1D';
    const colorLight = '#CC2B52';
    const colorBackground = '#FFDDAE';
    ...
    textSize(24);
    textAlign(RIGHT);
    text(currentScore, 535, 125);
    text(currentLevel, 535, 260);
    text(linesCleared, 535, 330);
